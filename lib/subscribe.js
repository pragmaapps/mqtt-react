...
function subscribe() {
  ...
  return function (TargetComponent) {
    var MQTTSubscriber = function MQTTSubscriber(props) {
      var _useContext = (0, _react.useContext)(_connector.MqttContext),
        contextClient = _useContext.mqtt;
      var client = props.client || contextClient;
      var _useState = (0, _react.useState)({}),
        _useState2 = _slicedToArray(_useState, 2),
        data = _useState2[0],
        setData = _useState2[1];
      var messageHandler = (0, _react.useCallback)(function (msgTopic, message) {
        ...
        setData(function (prevData) {
          return _objectSpread(_objectSpread({}, prevData), {}, _defineProperty({}, msgTopic, parsedMessage));
        });
      }, []);
      (0, _react.useEffect)(function () {
        if (!client) return;
        var topicsToSubscribe = Array.isArray(topic) ? topic : [topic];
      ...
      var deleteTopic = (0, _react.useCallback)(function (topicToDelete) {
        setData(function (prevData) {
          return (0, _lodash.omit)(prevData, [topicToDelete]);
        });
      }, []);
      var componentProps = (0, _react.useMemo)(function () {
        return _objectSpread(_objectSpread({}, (0, _lodash.omit)(props, 'client')), {}, {
          data: data,
          mqtt: client,
